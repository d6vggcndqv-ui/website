...
/* =====================================================================
   ...
   flight paths to the "tracks_pou" Firestore collection.
 
   How it works:
     - While an aircraft is within TRACK_RADIUS_KM of POU and at/below the
...
async function captureTracks() {
  try {
    ...
    data.aircraft.forEach(flight => {
      ...
      const dist = getDistance(POU_LAT, POU_LNG, flight.lat, flight.lon);
